...
def get_article_text(url):
    ...
    article_txt = soup.select_one("#product-description").text
    return(article_txt)

def print_article_text(article_1,article_2):
    diff_ratio = Levenshtein.ratio(get_article_text(article_1), get_article_text(article_2))
    diff_ratio = round(diff_ratio,4)
    if diff_ratio > 0.5:
        print(diff_ratio,end=",")
        print(article_1, end=",")
        print(article_2, end=",")
        print("")


print("diff ratio",end=",")
print("article_a",end=",")
print("article_b",end=",")
print("")
for url in itertools.combinations(urls, r=2):
    article_a = url[0]
    article_b = url[1]
    print_article_text(article_a, article_b)
